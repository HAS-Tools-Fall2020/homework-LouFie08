...
# %% To see whats inside and its format
type(gages)
var_names = gages.head()
gages.columns  # Variables name
gages.shape  # no. of gages and no. of varaibles
...
# %% To put it all together - adding our two points to the stream gagees 
fig, ax = plt.subplots(figsize=(5, 5))
gages_AZ.plot(column='DRAIN_SQKM', categorical=False,
