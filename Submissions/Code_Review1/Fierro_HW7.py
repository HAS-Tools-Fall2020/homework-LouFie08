...
wk1_pre = week_prediction(flow=wkly_flow_mean, m=m, b=b,
                          prev_wks=begining_week, end=ending_week, week_pred=1)
wk2_pre = week_prediction(flow=wkly_flow_mean, m=m, b=b,
                          prev_wks=begining_week, end=ending_week, week_pred=2)

print("")
print("Forecast submission values for Week 1 and Week 2 ")
